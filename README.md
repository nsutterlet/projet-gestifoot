...
![Alt text](static/capture01.PNG?raw=true "Title")
...
![Alt text](static/capture02.PNG?raw=true "Title")

Afichage des résutlats de la dernière journée.

![Alt text](static/capture04.PNG?raw=true "Title")
